...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
    try {
        ...
        const pushname = m.pushName || "Aiman"
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                ...
                                callButton: {
                                    displayText: 'Nᵾmƀɇɍ Ᵽħønɇ Øwnɇr📞',
                                    phoneNumber: '+60 10-281 0046'
                                }
                            }, {
                                quickReplyButton: {
